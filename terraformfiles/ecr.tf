...
provisioner "local-exec" {
  command = <<EOT
    ...
    docker tag containerized-application "${aws_ecr_repository.images.repository_url}:latest" 
    docker tag containerized-application "${aws_ecr_repository.images.repository_url}:$GIT_COMMIT_ID"
