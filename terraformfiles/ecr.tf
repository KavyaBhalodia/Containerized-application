...
provisioner "local-exec" {
  command = <<EOT
    ...
    docker build -t images:$GIT_COMMIT_ID  .
    
    docker tag images:$GIT_COMMIT_ID 831794387446.dkr.ecr.ap-south-1.amazonaws.com/images:$GIT_COMMIT_ID
    docker tag images:latest 831794387446.dkr.ecr.ap-south-1.amazonaws.com/images:latest
